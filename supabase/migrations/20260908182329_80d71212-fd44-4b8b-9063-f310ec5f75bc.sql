...
RETURNS integer LANGUAGE sql IMMUTABLE SET search_path = public AS $$
  SELECT LEAST(500, GREATEST(0, ROUND(_amount_usd * 100 * 0.10)::int));
$$;

GRANT EXECUTE ON FUNCTION public.first_deposit_bonus_cents(numeric) TO authenticated, service_role;
